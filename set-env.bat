...
set CMAKE_GENERATOR_SUFFIX=x64
shift
goto :loop
...
set DEBUG_SUFFIX=
set LLVM_TARGETS=AArch64,AMDGPU,ARM,AVR,BPF,Hexagon,Lanai,Mips,MSP430,NVPTX,PowerPC,RISCV,Sparc,SystemZ,WebAssembly,X86,XCore
